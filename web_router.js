...
router.put('/reset_password', sign.resetPassword);  // 更新密码 by cwl
router.put('/reset_password_to_initial', sign.resetPasswordToInitial);  // 更新密码 by cwl
...
router.post('/avatars', auth.userRequired, user.uploadAvatar)//上传头像
